...
function Free(customer) {
  ...
  return (
    <div className={`container ${!previewImg ? "disable" : ""}`}>
      <h2>Free Version ( User- {User})</h2>
      <div className="wrapper">
        <div className="editor-panel">
          <div className="filter" id={theme?"filter-dark":"filter-white"}>
        ...
        <dotlottie-player src="https://lottie.host/c74ecf7c-0525-496a-a912-3bb36e72064e/jsyEOUJwNv.json" background="transparent" speed="1"  style={{width:"20rem"}}  loop autoplay></dotlottie-player>
          )}
        </div>
      </div>
